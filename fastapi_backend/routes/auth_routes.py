...
def get_all_firebase_admin_users():
    from firebase_config import fs_list_all_users
    return {"users": fs_list_all_users()}

@router.get("/admin/media")
def get_all_firebase_admin_media():
    from firebase_config import fs_list_all_media
    return {"media": fs_list_all_media()}
