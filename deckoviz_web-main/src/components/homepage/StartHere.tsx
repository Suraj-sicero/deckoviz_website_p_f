...
import { Home, Sparkles, Tv, BookOpen, Smartphone, BrainCircuit, BookMarked } from "lucide-react";
        ...
        >
          {[1, 2].map((iteration) => (
            <div key={iteration} className="flex gap-4 sm:gap-8 shrink-0">
              ...
              {/* 🧠 Floating Nervous System Pill */}
              <button
                onClick={() => navigate("/nervous-system")}
                className="relative group flex items-center gap-3 px-5 sm:px-6 py-3 sm:py-3.5 rounded-full bg-gradient-to-r from-teal-400 via-cyan-400 to-teal-500 text-white shadow-[0_0_40px_rgba(45,212,191,0.4)] hover:shadow-[0_0_60px_rgba(45,212,191,0.6)] transition-all duration-500 backdrop-blur-xl min-w-[260px] sm:min-w-[300px] overflow-hidden hover:-translate-y-1"
              >
                {/* glow aura */}
                <div className="absolute inset-0 bg-gradient-to-r from-teal-300 via-cyan-300 to-teal-400 opacity-40 blur-2xl group-hover:opacity-70 transition" />
                {/* shimmer */}
                <div className="absolute inset-0 bg-gradient-to-r from-transparent via-white/40 to-transparent -translate-x-full group-hover:translate-x-full transition-transform duration-1000" />
                <div className="relative flex items-center gap-3 text-left">
                  <div className="w-10 h-10 rounded-full bg-white/25 backdrop-blur-md flex items-center justify-center shadow-inner shrink-0">
                    <span className="text-xl">🧠</span>
                  </div>
                  <div className="leading-tight">
                    <p className="text-xs opacity-90 tracking-wide">What If Your Home Had a</p>
                    <p className="text-sm font-bold tracking-wide">Nervous System?</p>
                  </div>
                </div>
              </button>

              {/* 📘 Hanging DAS Portal Card */}
              <div className="flex flex-col items-center select-none shrink-0">
                {/* Thumbtack pin */}
                <div className="relative z-10 flex flex-col items-center">
                  <div
                    className="w-[14px] h-[14px] rounded-full border border-white/30"
                    style={{
                  ...
                  />
                  <div
                    className="w-[2px] h-[8px] rounded-b-full"
                ...
                <button
                  onClick={() => navigate("/dasp-homes-guide")}
                  className="group relative overflow-hidden cursor-pointer hover:-translate-y-1 transition-all duration-500"
                  style={{
                    width: "140px",
                    borderRadius: "12px",
                    ...
                    boxShadow: "0 10px 32px rgba(30,58,138,0.5), 0 2px 6px rgba(0,0,0,0.2), inset 0 1px 0 rgba(255,255,255,0.2)",
                ...
                >
                  ...
                  <div
                    ...
                    style={{
                      backgroundImage: "repeating-linear-gradient(180deg, transparent, transparent 11px, rgba(255,255,255,1) 11px, rgba(255,255,255,1) 12px)",
                      borderRadius: "12px",
                    }}
                  />
                  {/* Shine sweep */}
                  ...
                  <div className="relative flex flex-col items-center text-center gap-1.5">
                    <div
                      className="w-7 h-7 rounded-lg flex items-center justify-center text-base mb-0.5 group-hover:scale-110 transition-transform duration-300"
                      style={{
                    ...
                    <p className="text-[7px] font-semibold uppercase tracking-[0.17em] text-white/75 leading-none">
                      A Quick But Comprehensive
                    </p>
                    <p className="text-[10px] font-extrabold text-white leading-snug group-hover:text-teal-200 transition-colors duration-300">
                      Guide To Your DAS Portal
                    </p>
                    <div
                      className="mt-1 px-2.5 py-[2px] rounded-full text-[8px] font-bold text-[#182A4A] group-hover:scale-105 transition-transform duration-300"
