    ...
    <div className="absolute top-4 left-4 z-20">
      <Badge className="bg-[#2563EB] text-white px-3 py-1 text-xs font-bold shadow-lg">
        ...
        Most Popular
          ...
          <div className="text-center mt-8 mb-12 flex flex-col items-center gap-3">
            <Link
            ...
            >
              ...
              <span className="ml-2 font-bold text-[#2563EB] transition-all duration-300 group-hover:translate-x-1 group-hover:text-[#1D4ED8]">
                →
              </span>
            </Link>
            ...
            <Link
              ...
              className="inline-flex items-center text-base sm:text-lg group hover:scale-105 transition-transform duration-300"
            >
              <span className="font-bold bg-gradient-to-r from-teal-700 to-blue-600 bg-clip-text text-transparent group-hover:from-teal-800 group-hover:to-blue-700 transition-all">
                View GeDiPortal v1 feature list
              </span>
              <span className="ml-2 font-bold text-[#2563EB] transition-all duration-300 group-hover:translate-x-1 group-hover:text-[#1D4ED8]">
                →
              </span>
