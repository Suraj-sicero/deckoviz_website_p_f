    ...
    <section className="py-12 md:py-16 lg:py-20 overflow-hidden relative bg-gradient-to-br from-gray-50 to-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid lg:grid-cols-2 gap-8 md:gap-12 lg:gap-16 items-center">
          ...
          <div className="space-y-6 md:space-y-8 order-2 lg:order-1">
            ...
            <motion.div initial={{ opacity: 0, y: 40 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.8, ease: "easeOut" }} className="space-y-2">
              ...
              <motion.h3 initial={{ opacity: 0, x: 30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ delay: 0.4, duration: 0.7 }} className="text-5xl sm:text-6xl md:text-7xl font-bold leading-tight" style={{ fontFamily: "'Playfair Display', serif" }}>
                <span className="text-gray-900">Transform Your</span>{" "}
                <span className="italic text-transparent bg-gradient-to-r from-purple-600 via-blue-600 to-pink-600 bg-clip-text bg-[length:200%_auto] animate-gradient">World.</span>
              </motion.h3>
            </motion.div>
            ...
            <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: 0.9, duration: 0.6 }} className="flex flex-wrap gap-2.5 pt-2">
              {[
                ...
                { text: "Nostalgic", color: "from-purple-500 to-pink-500", delay: 0.35 },
          ...
          {/* Right Content - Collage with Original Images */}
          <div className="relative order-1 lg:order-2 h-[500px] md:h-[600px]">
            {/* Large background art piece */}
            <motion.div 
              ...
              className="absolute top-0 right-0 w-[85%] h-[70%] bg-white p-4 shadow-2xl hover:shadow-3xl transition-shadow duration-300 cursor-pointer"
            >
              <img src="https://images.unsplash.com/flagged/photo-1572392640988-ba48d1a74457?q=80&w=764&auto=format&fit=crop" alt="Sculptural Art" className="w-full h-full object-cover" />
              <motion.p 
            ...
            >
              <img src="https://i.pinimg.com/736x/6a/14/5d/6a145d6fd6b80d62d3378ccfb75cbc5f.jpg" alt="Classical Sculpture" className="w-full h-full object-cover" />
            </motion.div>

            {/* Architecture - top right with pin */}
            <motion.div 
            ...
            >
              ...
              ></motion.div>
              <img src="https://i.pinimg.com/736x/1d/76/b8/1d76b855636a65684b11182f0fa99e43.jpg" alt="Ancient Architecture" className="w-full h-full object-cover" />
              <motion.p 
                initial={{ opacity: 0 }}
            ...
            <motion.div 
              ...
              className="absolute bottom-32 left-4 w-44 h-32 bg-white p-3 shadow-xl hover:shadow-2xl z-20 cursor-pointer transition-shadow duration-300"
            >
              <img src="https://i.pinimg.com/736x/7e/a8/88/7ea888763035ff1abe949afca1b4cd51.jpg" alt="Sunflowers" className="w-full h-full object-cover" />
              <motion.p 
                initial={{ opacity: 0, scale: 0.8 }}
                whileInView={{ opacity: 1, scale: 1 }}
            ...
            {/* Green landscape - bottom right with pin */}
            <motion.div 
              ...
              className="absolute bottom-8 right-12 w-36 h-40 bg-white p-3 shadow-xl hover:shadow-2xl z-30 cursor-pointer transition-shadow duration-300"
            >
              <motion.div 
              ...
              ></motion.div>
              <img src="https://plus.unsplash.com/premium_photo-1710787193520-74df05ed7736?q=80&w=1170&auto=format&fit=crop" alt="Green Hills" className="w-full h-full object-cover" />
              <motion.p 
            ...
            {/* Purple landscape - bottom center */}
            <motion.div 
              ...
              className="absolute bottom-4 left-1/3 w-32 h-28 bg-white p-2 shadow-xl hover:shadow-2xl z-25 cursor-pointer transition-shadow duration-300"
            >
              <img src="https://i.pinimg.com/736x/b0/3b/8e/b03b8e4a1188d6b68c001cd8e9e8b490.jpg" alt="Purple Landscape" className="w-full h-full object-cover" />
            </motion.div>
          </div>
        </div>
      </div>
