...
const OrderConfirmed = () => {
  ...
  useEffect(() => {
    ...
    if (sessionId) {
      fetch(`${import.meta.env.VITE_API_URL || (import.meta.env.VITE_API_URL || `${import.meta.env.VITE_API_URL || "https://ckoviz-backend.onrender.com"}`)}/order-details?session_id=${sessionId}`)
        .then(res => {
          if (!res.ok) {
        ...
        .then((data: OrderData) => {
          ...
          fetch(`${import.meta.env.VITE_API_URL || (import.meta.env.VITE_API_URL || `${import.meta.env.VITE_API_URL || "https://ckoviz-backend.onrender.com"}`)}/fulfill-credits`, {
            method: "POST",
