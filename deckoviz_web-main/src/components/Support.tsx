...
const Support: React.FC = () => {
  return (
    <div className="min-h-screen bg-gradient-to-br from-violet-50 via-white to-violet-100 px-6 pt-32 pb-20">

      <h1 className="text-4xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-violet-500 to-violet-600 text-center mb-14">
        Support Center
      </h1>
      ...
      <div className="max-w-5xl mx-auto space-y-12">
        ...
        {/* CARD 1 */}
        <div className="group bg-white rounded-3xl shadow-lg hover:shadow-violet-200 transition p-10 flex flex-col md:flex-row gap-10 items-center">
          <img src="/images/support-center.jpg" className="w-48 rounded-xl bg-violet-50 p-4" />
        ...
        {/* CARD 2 */}
        <div className="group bg-white rounded-3xl shadow-lg hover:shadow-violet-200 transition p-10 flex flex-col md:flex-row gap-10 items-center">
          <img src="/images/reach-us.jpg" className="w-48 rounded-xl bg-violet-50 p-4" />
          ...
          <div>
            ...
            <a
              ...
              className="inline-block mb-4 px-5 py-2 rounded-full bg-gradient-to-r from-violet-400 to-violet-500 text-white font-medium hover:scale-105 transition"
            >
              📧 support@deckoviz.com
            </a>

            <p className="text-gray-600 mb-2">
              We aim to respond within <strong className="text-violet-600">24 hours on business days</strong>.
            </p>
        ...
        {/* CARD 3 */}
        <div className="group bg-white rounded-3xl shadow-lg hover:shadow-violet-200 transition p-10 flex flex-col md:flex-row gap-10 items-center">
          <img src="/images/help.jpg" className="w-48 rounded-xl bg-violet-50 p-4" />
          ...
          <div>
            ...
            <ul className="space-y-2 mb-4">
              {[
                ...
                <li key={i} className="flex items-start gap-3 text-gray-600">
                  <span className="mt-2 w-2 h-2 rounded-full bg-violet-500"></span>
                  {item}
                </li>
              ))}
            </ul>
            ...
            <p className="text-gray-600 mt-4">
              ...
              <br />
              <strong className="text-violet-600">No question is too small.</strong>
            </p>
          </div>
        </div>
