...
export default function PragmaticBuyerGuide() {
  ...
  return (
    <>
      ...
      `}</style>
    <section className="relative min-h-screen overflow-hidden bg-gradient-to-br from-indigo-50 via-blue-50 to-indigo-50">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="absolute top-40 right-10 w-80 h-80 bg-blue-400/30 rounded-full blur-3xl animate-pulse" style={{ animationDelay: '1s' }}></div>
      ...
      {/* Top gradient bar */}
      <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-[#182A4A] via-[#2563EB] to-[#4f46e5] shadow-lg shadow-indigo-500/50"></div>
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6 py-20">
        ...
        <div className="relative backdrop-blur-xl bg-white/70 rounded-3xl shadow-2xl border border-white/50 p-8 md:p-12 lg:p-16">
          ...
          {/* Inner glow */}
          <div className="absolute inset-0 rounded-3xl shadow-inner shadow-indigo-500/10 pointer-events-none"></div>
          ...
          <div className="space-y-6 text-center relative">
            ...
            {/* Decorative elements */}
            <div className="absolute -top-10 left-1/2 -translate-x-1/2 w-32 h-32 bg-gradient-to-br from-[#4f46e5] to-[#2563EB] rounded-full blur-3xl opacity-30 animate-pulse"></div>
            
            {/* Main title with multiple effects */}
            <div className="relative">
              {/* Background glow */}
              <div className="absolute inset-0 bg-gradient-to-r from-[#182A4A] via-[#2563EB] to-[#4f46e5] blur-2xl opacity-20"></div>
              ...
              <h1 className="relative text-5xl md:text-6xl lg:text-7xl font-bold tracking-tight leading-tight" style={{ fontFamily: "'Playfair Display', serif" }}>
                <span className="inline-block bg-gradient-to-r from-[#182A4A] via-[#2563EB] to-[#4f46e5] bg-clip-text text-transparent animate-gradient bg-[length:200%_auto]">
                  The Deckoviz Guide
                </span>
                <br />
                <span className="inline-block mt-2 bg-gradient-to-r from-[#182A4A] via-[#2563EB] to-[#4f46e5] bg-clip-text text-transparent animate-gradient bg-[length:200%_auto]" style={{ animationDelay: '0.5s' }}>
                  for the <span className="italic bg-gradient-to-r from-[#182A4A] via-[#2563EB] to-[#4f46e5] bg-clip-text text-transparent">Pragmatic</span>
                </span>
                <br />
                <span className="inline-block mt-2 bg-gradient-to-r from-[#182A4A] via-[#2563EB] to-[#4f46e5] bg-clip-text text-transparent animate-gradient bg-[length:200%_auto]" style={{ animationDelay: '1s' }}>
                  Enterprise Buyer
                </span>
              </h1>
            </div>
            ...
            <div className="flex items-center justify-center gap-3 pt-4">
              ...
              <div className="w-2 h-2 rounded-full bg-gradient-to-r from-[#4f46e5] to-[#2563EB] animate-pulse"></div>
              <div className="h-px w-16 bg-gradient-to-l from-transparent to-pink-400"></div>
            </div>
          </div>

          {/* Introduction */}
          <div className="space-y-6 bg-gradient-to-br from-indigo-50/50 to-blue-50/50 rounded-3xl p-8 border border-indigo-100/50">
            ...
            <p className="text-2xl text-[#182A4A] leading-relaxed font-semibold text-center py-4">
              And yet.
            </p>
            ...
            <p className="text-xl text-[#182A4A] leading-relaxed font-semibold text-center">
          ...
          <div className="space-y-6 pt-8">
            <div className="relative">
              <div className="absolute -left-4 top-0 bottom-0 w-1 bg-gradient-to-b from-[#4f46e5] to-[#2563EB] rounded-full"></div>
            ...
            <div className="bg-white/60 rounded-2xl p-6 border border-indigo-100">
              <ul className="space-y-3 text-lg text-slate-700">
                <li className="flex items-start gap-3">
                  <span className="text-[#2563EB] mt-1.5 text-xl">•</span>
            ...
            <div className="bg-gradient-to-r from-indigo-50 to-blue-50 rounded-2xl p-6 border border-indigo-200">
              <p className="text-xl text-[#182A4A] leading-relaxed font-semibold">
          ...
          <div className="space-y-6 pt-8">
            ...
            <div className="bg-gradient-to-br from-violet-50 to-pink-50 rounded-3xl p-8 border border-indigo-100 space-y-6">
              <p className="text-xl text-slate-700 leading-relaxed">
