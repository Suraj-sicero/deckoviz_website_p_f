...
export default function AboutUs() {
  const [stars, setStars] = useState<{top: string, left: string, opacity: number, delay: number}[]>([]);
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-[#0B0A12] px-0 pb-0 space-y-16 overflow-x-hidden elinity-page">
      <ElinityNavbar />
      {/* About Us Card */}
 <div 
