    ...
    <div className="min-h-full bg-[#fafafa] pt-24 pb-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-16">
          <div className="inline-flex items-center justify-center p-3 bg-purple-100 rounded-2xl mb-4 animate-bounce">
            <Code className="w-8 h-8 text-purple-600" />
          </div>
          <h1 className="text-4xl md:text-6xl font-bold text-gray-900 mb-4 tracking-tight">
            Tool <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-600 to-pink-600">Generator</span>
          </h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {[
            ...
            <div key={i} className="group bg-white p-8 rounded-[2.5rem] shadow-xl border border-gray-100 hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2">
              ...
              <div className="mt-8 pt-6 border-t border-gray-50 flex items-center text-purple-600 font-semibold text-sm cursor-pointer hover:translate-x-2 transition-transform">
                Learn more 
        ...
        <div className="mt-20 bg-gradient-to-br from-[#0f172a] to-[#1e293b] rounded-[4rem] p-12 md:p-20 text-white text-center relative overflow-hidden shadow-2xl">
          <div className="absolute top-0 right-0 -mt-20 -mr-20 w-96 h-96 bg-purple-500/20 rounded-full blur-[120px]"></div>
          <div className="absolute bottom-0 left-0 -mb-20 -ml-20 w-96 h-96 bg-pink-500/20 rounded-full blur-[120px]"></div>
          
          <div className="relative z-10">
            <span className="px-4 py-2 bg-purple-500/10 border border-purple-500/20 rounded-full text-purple-400 text-xs font-bold uppercase tracking-widest mb-8 inline-block">
              Coming Soon
            </span>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <button className="w-full sm:w-auto px-12 py-5 bg-gradient-to-r from-purple-600 to-pink-600 text-white font-bold rounded-2xl hover:scale-105 transition-all duration-300 shadow-lg shadow-purple-500/25">
