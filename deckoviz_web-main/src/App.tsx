        ...
        <Routes>
          <Route
            ...
            element={
              <>
                <Hero />
                <div className="flex flex-wrap items-center justify-center gap-3 border-b border-slate-100 bg-white/80 backdrop-blur-sm px-4 py-3">
                  <Link
                    to="/pair"
                    id="btn-connect-device"
                    className="inline-flex items-center gap-2 rounded-full bg-gradient-to-r from-indigo-900 via-indigo-700 to-blue-600 px-5 py-2 text-xs font-bold uppercase tracking-widest text-white shadow-[0_5px_15px_rgba(37,99,235,0.35)] transition-all duration-300 hover:scale-105 hover:-translate-y-0.5 hover:shadow-[0_10px_25px_rgba(37,99,235,0.55)] active:scale-95"
                  >
                    <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><rect x="2" y="3" width="20" height="14" rx="2"/><path d="M8 21h8M12 17v4"/></svg>
                    Connect Device
                  </Link>
                  <Link
                    to="/display"
                    id="btn-send-photo"
                    className="inline-flex items-center gap-2 rounded-full border border-indigo-200 bg-white px-5 py-2 text-xs font-bold uppercase tracking-widest text-indigo-900 shadow-sm transition-all duration-300 hover:scale-105 hover:-translate-y-0.5 hover:border-indigo-400 hover:shadow-[0_6px_18px_rgba(37,99,235,0.18)] active:scale-95"
                  >
                    <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><rect x="3" y="3" width="18" height="18" rx="2"/><circle cx="9" cy="9" r="2"/><path d="m21 15-3.086-3.086a2 2 0 0 0-2.828 0L6 21"/></svg>
                    Send Photo
                  </Link>
                </div>
